    ...
    <div class="container mx-auto px-4 md:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="text-center" data-aos="fade-right" data-aos-delay="100">
          ...
          <h3 class="text-xl font-bold mb-3">Jaminan Kualitas</h3>
          <p class="text-gray-600">
            Kami menjaga standar kualitas tertinggi dalam setiap proyek yang kami kerjakan.
          </p>
        </div>
        ...
        <div class="text-center" data-aos="fade-right" data-aos-delay="300">
          ...
          <h3 class="text-xl font-bold mb-3">Tim Ahli</h3>
          <p class="text-gray-600">
            Tenaga profesional kami membawa keahlian dan inovasi dalam setiap proyek.
          </p>
        </div>

        <!-- Feature 4 -->
        <div class="text-center" data-aos="fade-left" data-aos-delay="400">
          <div
          ...
          <p class="text-gray-600">
            Kami menawarkan harga yang bersaing tanpa mengorbankan kualitas atau layanan.
          </p>
        </div>

        <!-- Feature 5 -->
        <div class="text-center" data-aos="fade-right" data-aos-delay="500">
          <div
        ...
        <!-- Feature 6 -->
        <div class="text-center" data-aos="fade-left" data-aos-delay="600">
          <div
  ...
  <section class="py-20 bg-gray-50 bg-pattern-light">
    <div class="container mx-auto px-4 md:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        <h2 class="text-4xl md:text-5xl font-bold mb-6">Our Best Services</h2>
        <div
          class="w-24 h-1 bg-gradient-to-r from-accent to-secondary mx-auto mb-6"></div>
        <p class="text-gray-600 max-w-3xl mx-auto text-lg">
          We provide comprehensive construction and infrastructure services
          with the highest quality standards and professional expertise.
        </p>
      </div>
