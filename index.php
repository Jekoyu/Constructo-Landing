        ...
        <div class="container mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-4">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6" data-aos="fade-right" data-aos-delay="100">
                    <h3 class="text-xl font-bold mb-4 text-gray-800">Alamat Kantor</h3>
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <p class="text-gray-600 text-sm">
                                Leuweung Sawo RT/RW. 002/009, Kelurahan Kotabumi, Kecamatan Purwakarta, Kota Cilegon, Provinsi Banten 42434.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6" data-aos="fade-left" data-aos-delay="200">
                    <h3 class="text-xl font-bold mb-4 text-gray-800">Hubungi Kami</h3>
                    <div class="space-y-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <a href="https://wa.me/6282136849377" class="text-blue-600 hover:underline text-sm block">+62 821-3684-9377</a>
                                <a href="https://wa.me/6282311377731" class="text-blue-600 hover:underline text-sm block">+62 823-1137-7731</a>
                            </div>
                        </div>
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:ancatamaabadi@gmail.com" class="text-blue-600 hover:underline text-sm">ancatamaabadi@gmail.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6" data-aos="fade-right" data-aos-delay="300">
                    ...
                    <ul class="space-y-3 text-gray-600 text-sm">
                        <li class="flex justify-between items-center">
                            ...
                            <span class="font-medium bg-green-100 text-green-800 px-3 py-1 rounded-full">08:00 - 17:00</span>
                        </li>
                        <li class="flex justify-between items-center">
                            <span>Sabtu:</span>
                            <span class="font-medium bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full">09:00 - 13:00</span>
                        </li>
                        <li class="flex justify-between items-center">
                            <span>Minggu & Hari Libur:</span>
                            <span class="font-medium bg-red-100 text-red-800 px-3 py-1 rounded-full">Tutup</span>
                        </li>
                    </ul>
                </div>
